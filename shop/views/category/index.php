 ...
 <main>
            ...
            <section class="slider-area pos-relative">
                <div class="slider-active">
                    <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="img/slider/1.png">
...
-->
                    ...
                    <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="img/slider/2.png">
                        <div class="shape-title bounce-animate">
                            <h2>UX</h2>
                        </div>
                        <div class="shape-icon bounce-animate">
                                ...
                                <div class="seller-box text-center">
                                    <div class="top-seller-content text-left">
                                        ...
                                        <div class="pro-price mb-25">
                                            ...
                                            <span class="old-price"><?= $t->old_price?> USD</span>
                                        </div>
                            ...
                            <div class="product-tab-content">
                                <div class="tab-content" id="myTabContent1">
                                    <div class="tab-pane fade show active" id="home1" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="product-slider owl-carousel">
                                        <?php $count=count($sale); $i=0;foreach($sale as $s): ?>
                                                <?php if($i%4==0): ?> 
                                                   <div class="pro<?php if($i == 0) echo '-item' ?>">
                                                <?php endif; ?>
                                                <div class="product-wrapper mb-50">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <h4>
                                                            <a href="<?= yii\helpers\Url::to(['product/view','id'=>$n->id]) ?>"><?= $s->name ?></a>
                                                        </h4>
                                                        <div class="product-meta">
                                                            <div class="pro-price">
                                                                <span><?= $s->price?> USD</span>
                                                                <span class="old-price"><?= $s->old_price?> USD</span>
                                                            </div>
                                                        </div>
                                                        <a href="<?=\yii\helpers\Url::to(['cart/add','id'=>$n->id])?>"><button data-id="<?= $n->id?>" class="btn theme-btn add-to-cart" >купить</button></a>
                                                        <div class="product-wishlist">
